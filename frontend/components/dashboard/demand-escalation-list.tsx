...
const MOCK_ESCALATIONS = [
  { id: 'DMD-8492-C', department: 'CIVIL' as Department, section: 'DLI-ALD', reason: 'Failed 3 solver retries', timestamp: '14:23:00' },
  { id: 'DMD-9120-T', department: 'TRD' as Department, section: 'NDLS-CNB', reason: 'Hard conflict with WTT', timestamp: '14:45:12' },
];
  ...
  return (
    <Card className="mb-6 border-destructive/50 shadow-sm">
      <CardHeader className="pb-3 bg-destructive/5 rounded-t-lg border-b border-destructive/10">
        ...
        <CardDescription>
          These demands have failed automatic resolution and require human intervention (FSM-002).
        </CardDescription>
      </CardHeader>
