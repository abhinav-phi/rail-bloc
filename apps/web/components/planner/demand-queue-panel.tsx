      ...
      <ScrollArea className="flex-1">
        <div className="p-3 grid gap-2">
          {MOCK_DEMANDS.map((demand) => (
            <div
              key={demand.id}
              className="p-3 border rounded-md bg-card shadow-sm cursor-grab active:cursor-grabbing hover:border-primary/50 transition-colors"
            >
